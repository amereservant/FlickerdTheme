...
<form id="commentform" action="#" method="post">
	...
	<p>
	    ...
	    <?php flkrPrintCommentField( 'name', 'name', '', html_encode($stored['name']), 'text', $disabled['name'], true ); ?>
    ...
    <p>
        ...
        <?php flkrPrintCommentField( 'email', 'email', '', html_encode($stored['email']), 'text', $disabled['email'], true ); ?>
    </p><!-- End of email field -->
					
	<p>
	    <label for="website"><?php echo gettext("Site:"); ?></label>
		<?php flkrPrintCommentField( 'website', 'website', '', html_encode($stored['website']), 'text', $disabled['website'], true ); ?>
	...
	<p>
	    ...
	    <?php flkrPrintCommentField( '0-comment_form_street', 'comment_form_street', '', html_encode($stored['street']), 'text', $disabled['street'], true ); ?>
	</p><!-- End of street field -->
	
	<p>
	    <label for="comment_form_city"><?php echo gettext('city:'); ?></label>
	    <?php flkrPrintCommentField( '0-comment_form_city', 'comment_form_city', '', html_encode($stored['city']), 'text', $disabled['city'], true ); ?>
	</p><!-- End of city field -->
	
	<p>
	    <label for="comment_form_state"><?php echo gettext('state:'); ?></label>
		<?php flkrPrintCommentField( '0-comment_form_state', 'comment_form_state', '', html_encode($stored['state']), 'text', $disabled['state'], true ); ?>
	</p><!-- End of state field -->
	
	<p>
	    <label for="comment_form_country"><?php echo gettext('country:'); ?></label>
		<?php flkrPrintCommentField( 'comment_form_country', 'comment_form_country', '', html_encode($stored['country']), 'text', $disabled['country'], true ); ?>
    </p><!-- End of country field -->
	
	<p>
	    <label for="comment_form_postal"><?php echo gettext('postal code:'); ?></label>
	    <?php flkrPrintCommentField( '0-comment_form_postal', 'comment_form_postal', '', html_encode($stored['postal']), 'text', $disabled['postal'], true ); ?>
